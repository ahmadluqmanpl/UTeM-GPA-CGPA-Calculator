...
- `Unofficial-UTeM-GPA-CGPA-Calculator-1.0.0-setup.exe`
...
The expected portable artifact is `offline-windows/dist/Unofficial-UTeM-GPA-CGPA-Calculator-1.0.0-portable.exe`. It is optional rather than the main sharing method. The existing `offline-windows/build/icon.ico` is also used when this optional artifact is rebuilt.
